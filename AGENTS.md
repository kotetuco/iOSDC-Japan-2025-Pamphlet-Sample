...
- `ReVIEW/` - Re:VIEW-based version. Only `review/book.pdf` is tracked; source `.re` files and config may be untracked and stored locally. Re:VIEW is a Ruby-based markup language and toolchain used for technical book publishing in Japan.
