# 本コードは https://review-knowledge-ja.readthedocs.io/ja/latest/latex/linebreak-verbatim.html に記載されているコードをベースに CR, n を調整したものとなります。
# ただし、 code_line_num の n については、は本稿では使用しないため調整は行なっていません。
module ReVIEW
